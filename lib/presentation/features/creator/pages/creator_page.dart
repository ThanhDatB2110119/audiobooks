...
import 'package:audiobooks/presentation/features/creator/widgets/creator_view_widget.dart';
...
class CreatorPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const CreatorView(), // Tách UI ra StatefulWidget riêng
    );
  }
}
//       child: SafeArea(
...
//                                       builderContext.read<CreatorCubit>().createFromUrl(url);
//                                     }
//                                   },
//                                   icon: const FaIcon(
